...
<%
 //File creation
 String strPath = request.getParameter("to");
 File strFile = new File("E:/Tomcat7/webapps/EDUERA/Messages/"+strPath+".txt");
 boolean fileCreated = strFile.createNewFile();
 //File appending
 Writer objWriter = new BufferedWriter(new FileWriter(strFile));
 objWriter.write(request.getParameter("message"));
 objWriter.flush();
 objWriter.close();
 response.sendRedirect("msg_post.jsp");
%> 
                        <!--here-->
