...
String password=session.getAttribute("pas").toString();
...
String host="smtp.gmail.com",user="", pass="engineers";
		...
		String subject = "Your user and Password";
		String messageText = "Your User Name Is :"+username+"And Password Is :"+password;
